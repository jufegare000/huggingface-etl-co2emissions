...
from application.data_preparation.services.s3.s3_service_implemented import (
    S3ServiceImplemented,
)

PATCH_CSV_COLUMNS = "application.data_preparation.services.s3.s3_service_implemented.CSV_COLUMNS"
