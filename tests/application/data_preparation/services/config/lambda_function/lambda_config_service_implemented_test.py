...
PATCH_ENV_SERVICE = "application.data_preparation.services.config.lambda_function.lambda_config_service_implemented.env_service"
PATCH_CONFIG_PARAMS = "application.data_preparation.services.config.lambda_function.lambda_config_service_implemented.DataPreparationConfigParams"
