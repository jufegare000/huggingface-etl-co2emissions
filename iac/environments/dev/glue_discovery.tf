...
resource "aws_s3_object" "glue_discovery_script" {
  ...
  source = "../../../src/data_discovery/infrastructure/into/glue/discovery/0_discovery_job.py"
  etag   = filemd5("../../../src/data_discovery/infrastructure/into/glue/discovery/0_discovery_job.py")
}
