...
from config.injection.dependency_injector import data_manifest_builder
...
def persist_preparation_output(
    ...
    manifest, manifest_key = data_manifest_builder.build_manifest(partitions, bucket, config)
